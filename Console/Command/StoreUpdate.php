...
class StoreUpdate extends Command
{
    ...
    {
        $this->setName('kimonix:store-update')
            ->setDescription('Manually pull store info and configuration from Kimonix');
        parent::configure();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        try {
            ...
            $this->getObjectManager()->get(Jobs\StoreUpdate::class)
                ->initConfig([
                    "output" => $output,
                ])->execute();
